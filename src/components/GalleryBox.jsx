    ...
    return (
        <>
            <div className="box rounded-3 position-relative shadow-lg">
                ...
                <h2 style={{ color: title_1 == 'Chain' ? 'white' : 'black' }} className=' fs-1 position-absolute translate-middle fw-semibold'>
                    <span style={{ color: title_1 == 'Chain' ? '#AA8453' : '#0A5D5D' }}>{title_1}&nbsp;</span>{title_2}
                </h2>
                ...
                >
                    <button 
                        style={{ 
                            background: title_1 == 'Chain' ? 'white' : '#2c2c2c', 
                            color: title_1 == 'Chain' ? 'black' : 'white' 
                        }} 
