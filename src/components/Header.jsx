                                                ...
                                                {category.subcategories.length > 0 && (
                                                    <div className="dropdown-item-children ms-3">
                                                        {category.subcategories.map(subcategory => (
                                                            <Link
                                                                key={subcategory._id}
                                                                href={`/collection?category=${encodeURIComponent(category.name)}&subcategory=${encodeURIComponent(subcategory.name)}`}
                                                                className="d-block px-3 py-2 text-decoration-none hover-bg-light"
                                                            >
                                                                {subcategory.name}
                                                            </Link>
                        ...
                        <div className='icons d-flex align-items-center'>
                            ...
                            <div className="wish position-relative">
                                <Link href="/wishlist" className='text-decoration-none text-black'>
                                    <RiHeart2Line size={40} className='me-sm-2 me-1 rounded-3 px-2 pt-1 iconHover' />
                                </Link>
                                <sup className='position-absolute end-0 translate-middle rounded-circle text-white' style={{ backgroundColor: '#0a5d5d', padding: '8px 6px', top: '28%' }}>{Wishcount}</sup>
                            </div>
                            <div className="cart position-relative">
